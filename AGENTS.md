...
## Workspace Overview
This package is developed across a **multi-project workspace**:
...
- **Blade components** registered with `crm-` prefix: `crm-header`, `crm-delete-confirm`, `crm-index-toggle`, `crm-phones`, `crm-emails`, `crm-addresses`, `crm-note`, `crm-app-layout` — view components in `src/View/Components/`
...
### Host 2: Laravel 12 (`laravel-12-crm-v2`)
...
### Host 3: Premium (`laravel-crm-premium`)
...
php artisan laravelcrm:sample-data   # generate sample CRM data for development
