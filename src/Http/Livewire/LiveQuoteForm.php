...
class LiveQuoteForm extends Component
{
    ...
    public function mount($quote, $generateTitle = true, $client = null, $organization = null, $person = null)
    {
        ...
        $this->organization_id = old('organization_id') ?? $quote->organization->id ?? $organization->id ?? null;
        $this->organization_name = old('organization_name') ?? $quote->organization->name ?? $organization->name ?? null;
    ...
    public function generateTitle()
    {
        if ($this->generateTitle) {
            if ($this->client_name) {
                ...
                $this->title = $this->organization_name.' '.ucfirst(trans('laravel-crm::lang.quote'));
