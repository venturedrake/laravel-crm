...
class EmailCampaignIndex extends Component
{
    ...
    public function delete($id)
    {
        if ($campaign = EmailCampaign::find($id)) {
            ...
            $campaign->delete();
            $this->success(ucfirst(__('laravel-crm::lang.email_campaign')).' '.__('laravel-crm::lang.deleted'));
        }
    }

    public function render()
    {
        return view('laravel-crm::livewire.email-campaigns.email-campaign-index', [
