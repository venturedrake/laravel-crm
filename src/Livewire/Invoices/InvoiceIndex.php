...
class InvoiceIndex extends Component
{
    ...
    public function headers()
    {
        return [
            ...
            ['key' => 'invoice.name', 'label' => ucfirst(__('laravel-crm::lang.contact')), 'sortable' => false],
    ...
    {
        return Invoice::when($this->user_id, fn (Builder $q) => $q->whereIn('user_owner_id', $this->user_id))
