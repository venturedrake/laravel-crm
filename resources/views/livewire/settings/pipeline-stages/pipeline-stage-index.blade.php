<div class="crm-content">
    ...
    <x-mary-card shadow>
        <x-mary-table :headers="$headers" :rows="$pipelineStages" :link="route('laravel-crm.pipeline-stages.show', ['pipelineStage' => '[id]'])" with-pagination :sort-by="$sortBy" class="whitespace-nowrap">
