    ...
    <div class="grid gap-3">
        <div class="flex justify-between items-start">
            ...
            <x-mary-dropdown right top>
                ...
                <x-mary-menu-item onclick="modalDeleteLunchItem{{ $lunch->id }}.showModal()" title="{{ ucfirst(__('laravel-crm::lang.delete')) }}" />
            </x-mary-dropdown>
        </div>
        ...
        @else
            ...
            <dialog id="modalDeleteLunchItem{{ $lunch->id }}" class="modal">
                <div class="modal-box text-left">
                    <h3 class="text-lg font-bold">Delete lunch?</h3>
                    <p class="py-4">You're about to delete this lunch. This action cannot be reversed.</p>
