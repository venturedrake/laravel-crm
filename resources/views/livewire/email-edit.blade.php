<div class="email-addresses">
    <h6 class="text-uppercase section-h6-title"><span>{{ ucfirst(__('laravel-crm::lang.emails')) }}</span> <span class="float-right"><button class="btn btn-outline-secondary btn-sm" wire:click.prevent="add({{$i}})"><span class="fa fa-plus" aria-hidden="true"></span></button></span></h6>
    <hr />
        ...
        <div class="row">
            ...
            <div class="col-sm-4">
                <div class="form-group">
                    ...
                    <select class="form-control" wire:model="type.{{ $value }}" name="emails[{{ $value }}][type]>
