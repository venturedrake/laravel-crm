<div class="grid lg:grid-cols-2 gap-5">
    ...
    <x-mary-input wire:model="url" label="{{ ucfirst(__('laravel-crm::lang.url')) }}" placeholder="https://example.com" class="lg:col-span-2" />
    ...
    <x-mary-input wire:model="expected_response_keyword" label="{{ ucfirst(__('laravel-crm::lang.expected_response_keyword')) }}" />
    <x-mary-input wire:model="interval" type="number" label="{{ ucfirst(__('laravel-crm::lang.interval')) }} (s)" />
