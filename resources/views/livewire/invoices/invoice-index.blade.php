<div class="crm-content">
    ...
    <x-mary-card shadow>
        <x-mary-table :headers="$headers" :rows="$invoices" link="/invoices/{id}" with-pagination :sort-by="$sortBy" class="whitespace-nowrap">
            @scope('cell_labels', $invoice)
                @foreach($invoice->labels as $label)
            ...
            <x-mary-button onclick="modalDeleteLead{{ $invoice->id }}.showModal()" icon="o-trash" class="btn-sm btn-square btn-error text-white" spinner />
