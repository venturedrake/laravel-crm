<div class="crm-content">
    <x-mary-header title="{{ ucfirst(__('laravel-crm::lang.create')) }} {{ __('laravel-crm::lang.sms_campaign') }}" />
    ...
    <x-mary-form wire:submit="save">
        ...
        <x-slot:actions>
            <x-mary-button label="{{ ucfirst(__('laravel-crm::lang.cancel')) }}" link="{{ route('laravel-crm.sms-campaigns.index') }}" />
