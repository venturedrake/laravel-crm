            ...
            <div class="col col-md-10">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title float-left m-0"> {{ ucfirst(__('laravel-crm::lang.tax_rates')) }}</h3>
                        @can('create crm tax rates')<span class="float-right"><a type="button" class="btn btn-primary btn-sm" href="{{ url(route('laravel-crm.tax-rates.create')) }}"><span class="fa fa-plus"></span>  {{ ucfirst(__('laravel-crm::lang.add_tax_rate')) }}</a></span>@endcan
                    </div>
                            ...
                            <div class="table-responsive">
                                <table class="table mb-0 card-table table-hover">
                                    ...
                                    <tr>
                                        ...
                                        <th scope="col">{{ ucfirst(__('laravel-crm::lang.tax_type')) }}</th>
