<form method="POST" action="{{ url(route('laravel-crm.purchase-orders.store')) }}">
    ...
    @component('laravel-crm::components.card')
        ...
        @component('laravel-crm::components.card-header')
            ...
            @slot('title')
                {{ ucfirst(__('laravel-crm::lang.create_purchase_order')) }} @isset($order){{ __('laravel-crm::lang.from_order') }} <a href="{{ route('laravel-crm.orders.show', $order) }}">{{ $order->order_id }}</a> @endisset
            @endslot
