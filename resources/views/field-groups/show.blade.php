    ...
    <div class="card">
        ...
        <div class="card-body">
            <h3 class="mb-3"> {{ $fieldGroup->name }} <span class="float-right">
                ...
                @can('edit crm fields')
                <a href="{{ url(route('laravel-crm.field-groups.edit', $fieldGroup)) }}" type="button" class="btn btn-outline-secondary btn-sm"><span class="fa fa-edit" aria-hidden="true"></span></a>
                @endcan
