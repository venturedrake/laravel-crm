...
@section('content')
    ...
    <div class="card">
        <div class="card-header"><h3 class="card-title float-left m-0">{{ $person->title }}</h3>
            <span class="float-right">
                ...
                <a href="{{ url(route('laravel-crm.people.edit', $person)) }}" type="button" class="btn btn-outline-secondary btn-sm">Edit</a>
            </span>
        </div>
