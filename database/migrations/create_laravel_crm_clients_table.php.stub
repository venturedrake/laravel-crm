...
class CreateLaravelCrmClientsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create(config('laravel-crm.db_table_prefix').'clients', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists(config('laravel-crm.db_table_prefix').'clients');
    }
}
