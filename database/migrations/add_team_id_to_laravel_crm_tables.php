...
class AddTeamIdToLaravelCrmTables extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create(config('laravel-crm.db_table_prefix').'crm_teams', function (Blueprint $table) {
            $table->unsignedBigInteger('team_id')->after('id')->index()->nullable();
        });
    ...
    public function down()
    {
        ...
        Schema::table(config('laravel-crm.db_table_prefix').'crm_teams', function (Blueprint $table) {
            $table->dropColumn(['team_id']);
        });
